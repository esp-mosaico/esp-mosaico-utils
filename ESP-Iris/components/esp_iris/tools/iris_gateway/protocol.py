...
class TlvTag(enum.IntEnum):
    ...
    MAX_PAYLOAD = 0x0D
    FIRMWARE_ROLE = 0x0E
    PRODUCT_CONTRACT = 0x0F
    CHIP_TARGET = 0x10
    BOARD_ID = 0x11
    RECOVERY_ABI = 0x12
    REQUIRED_FEATURES = 0x13
    ...
    CRASH_COUNT = 0x38
    CRASH_LIMIT = 0x39
    CRASH_LOOP_TRIGGERED = 0x3A
    CRASH_RECOVERY_PENDING = 0x3B
    CRASH_ORIGIN_RESET_REASON = 0x3C
    CRASH_FAILED_APP_ADDRESS = 0x3D
    CRASH_FAILED_FIRMWARE_SHA256 = 0x3E
    CRASH_STATE_ERROR = 0x3F
    AUTH_CHALLENGE = 0x40
    JOB_ID = 0x41
    JOB_STATE = 0x42
    JOB_PROGRESS = 0x43
