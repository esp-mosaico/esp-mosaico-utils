...
- `esp-mosaico-recovery/` owns the ESP-Mosaico host CLI, retained Recovery
  firmware, reviewed Recovery bundle, and its tests.
...
- Build affected ESP-IDF examples and fixtures with a compatible, verified
  ESP-IDF checkout. Recovery currently requires ESP-IDF 6.1 or newer and the
  ESP32-S31 target.
